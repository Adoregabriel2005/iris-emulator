...
#include "../../../../src/ui/WelcomeDialog.h"
...
static constexpr auto qt_meta_stringdata_ZN13WelcomeDialogE = QtMocHelpers::stringData(
    "WelcomeDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13WelcomeDialogE[] = {
...
Q_CONSTINIT const QMetaObject WelcomeDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13WelcomeDialogE.offsetsAndSizes,
    qt_meta_data_ZN13WelcomeDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13WelcomeDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *WelcomeDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13WelcomeDialogE.stringdata0))
